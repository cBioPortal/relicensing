# Contributor Outreach — Slack Broadcast Template

*Generic message for posting in Slack channels reaching multiple contributors at once. For one-on-one outreach with per-contributor details (repo, commit count), use `outreach-individual-template.md` instead.*
...
Questions → reply here or email gaoj@mskcc.org. Status board: https://github.com/cBioPortal/relicensing/blob/main/docs/relicensing/contributor-consent-status.md
