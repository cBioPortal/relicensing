...
- **Tier 1**: Written approval from the **team lead** of the cBioPortal team at each contributing organization — MSKCC, DFCI, PMCC, CHOP, Hyve, SE4BIO — at the team-lead level rather than routed through formal legal/tech-transfer review, to fit the timeline. Consent is collected via [cbioportal#12282](https://github.com/cBioPortal/cbioportal/issues/12282); terms document at `docs/relicensing/outreach-tier1-letter.md`. See Decisions section below.
...
- **Tier 1 sign-off level (2026-07-10, updated 2026-07-31):** Get Tier 1 team lead consent from each cBioPortal team lead/PI directly, rather than routing through formal legal/tech-transfer review. Collected via public GitHub issue [cbioportal#12282](https://github.com/cBioPortal/cbioportal/issues/12282) (same mechanism as Tier 2 individual consent); terms document at `docs/relicensing/outreach-tier1-letter.md`. Rationale: non-commercial, mission-aligned open source tool; team leads can respond far faster than a legal department — necessary to hit the 2026-09-30 deadline. Trade-off: a team lead may not have actual authority to bind their organization; mitigated by an explicit authority attestation in their consent comment. Revisit for any team where this basis feels shaky.
