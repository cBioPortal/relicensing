...
- **Tier 1**: Written approval from the **team lead** of the cBioPortal team at each contributing organization — MSKCC, DFCI, PMCC, CHOP, Hyve, SE4BIO — at the team-lead level rather than routed through formal legal/tech-transfer review, to fit the timeline. Letter explicitly invites the lead to redirect to the appropriate authority if their organization requires it. See Decisions section below.
...
| **Team-lead sign-off authority** | Tier 1 consent is signed by team leads, not formal legal/tech-transfer review — faster, but weaker legal footing if a lead lacks actual authority to bind their team's contributions. See Decisions. |
...
- **Tier 1 sign-off level (2026-07-10):** Get Tier 1 team lead consent from each cBioPortal team lead/PI directly, rather than routing through formal legal/tech-transfer review. Rationale: this is a non-commercial, mission-aligned open source tool, not a contested IP matter, and team leads can turn around a response far faster than a legal department — necessary to hit the 2026-09-30 deadline. Trade-off: a team lead may not have actual authority to bind their organization; mitigated by having the letter (`docs/relicensing/outreach-tier1-letter.md`) explicitly invite redirection to the appropriate authority if the lead's organization requires it, and by an explicit authority attestation in the consent. Revisit for any team where this basis feels shaky.
...
- **Repo stays public; sensitive originals go elsewhere (2026-07-11):** Considered and rejected making `cBioPortal/relicensing` private to hold sensitive records. Reasons: the live public consent-collection issue ([cbioportal#12271](https://github.com/cBioPortal/cbioportal/issues/12271)) links directly into this repo; Phase 3 already commits to a public 30-day notice period; and the whole Phase 2 design deliberately mirrors mpv/VLC/Dolphin's public-transparency approach. Instead, signed Tier 1 letters, legal correspondence, and other documents with personal signatures/institutional specifics are stored in a private Google Drive folder: https://drive.google.com/drive/folders/1pGq4cS1S_gKhCsOsIO7sTEo5IQ9i4pTI — the public record (sign-off gate, relicensing#5) links to this folder as the location of record, without embedding the documents themselves.
